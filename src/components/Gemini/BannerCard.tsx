      ...
      <div className="absolute inset-0 z-20 p-6 sm:p-8 md:p-10 flex flex-col justify-between text-white">
        ...
        <div>
          {modalId ? (
            <button
              onClick={onClick}
              className="mb-2 sm:mb-4 px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-lg bg-white/20 hover:bg-white/30  backdrop-blur rounded-full text-white font-medium transition-colors duration-200 flex items-center gap-2 z-30 relative"
            >
            ...
            <a
              href={link}
              className="mb-2 sm:mb-4 inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-lg bg-white/30 hover:bg-white/20  backdrop-blur rounded-full text-white/90 font-medium transition-colors duration-200 z-30 relative"
            >
              Learn more <ArrowUpRight className="w-4 h-4 sm:w-5 sm:h-5" />
            </a>
          )}
